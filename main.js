...
async function loadConfig(ctx) {
  ...
  if (ctx.globalconfig["nodejs_ssl"] == 1 && keyPath && certPath && fs.existsSync(keyPath) && !fs.lstatSync(keyPath).isDirectory() && fs.existsSync(certPath) && !fs.lstatSync(certPath).isDirectory()) {
